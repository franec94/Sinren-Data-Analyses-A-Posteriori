...
from utils.custom_argparsers import get_argparser_for_generating_data, preprocess_cmd_line_args_for_jpeg_compression

from utils.classes import JpegCompressionResult, BenfordResult

from utils.compression_work import calculate_compressions_by_quality, calculate_occurences_for_benford_law, get_benfords_from_cntrs

from utils.handle_server_connection_2 import get_sql_statement_insert_jpeg_compressions_table, insert_data_by_sql_statement, get_sql_statement_insert_table, get_sql_statement_check_in_table