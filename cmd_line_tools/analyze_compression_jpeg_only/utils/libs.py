...
from utils.custom_argparsers import get_argparser_for_jpeg_compression, preprocess_cmd_line_args_for_jpeg_compression
...
from utils.handle_server_connection_2 import get_sql_statement_insert_jpeg_compressions_table, insert_data_by_sql_statement